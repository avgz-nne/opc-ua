...
async def main():
    ...
    tigo_nsidx = 6
    nsidx = 2
    tigo_nodeids = [32824, 98360, 163896] #[pressure pipe, #pressure tan level, temperature pipe, conductivity]
    nodeids = [2,3,4] #[pressure pipe, #pressure tan level, temperature pipe, conductivity]
